    ...
    <div x-data="{
        ...
        <div class="-mt-2 mb-10">
            ...
            <div x-show="!loading" x-cloak class="relative group">
                ...
                <a href="{{ route('persidangan', request()->except(['search', 'page'])) }}"
                ...
                {{-- 2. Dynamic Jenis Persidangan Cards --}}
                @foreach($jenisPersidanganSummary as $jenis)
                    <a href="{{ route('persidangan', array_merge(request()->except('page'), ['search' => $jenis->nama_jenis])) }}"
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <h2 class="text-base font-bold text-gray-900">Daftar Kegiatan Persidangan</h2>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        {{-- Export Button & Modal --}}
                        <div x-data="{ exportOpen: false, exportFormat: 'pdf', selectAll: true, columns: { tanggal: true, waktu: true, nama_persidangan: true, jenis_persidangan: true, anggota_dewan: true, tempat: true } }" 
                             class="relative">
                            ...
                            <div x-show="exportOpen" 
                                ...
                                style="display: none; z-index: 9999;">
                                 ...
                                 <div @click.outside="exportOpen = false"
                                     class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden transform transition-all">
                                    ...
                                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">Konfigurasi kolom data dan format file untuk penarikan laporan persidangan</p>
                                        </div>
                                    ...
                                    <form action="{{ route('persidangan') }}" method="GET" class="flex flex-col overflow-hidden">
                                         ...
                                         <div class="p-6 space-y-6 flex-1 overflow-y-auto custom-scrollbar">
                                            ...
                                            <div>
                                                ...
                                                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                                    ...
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        <input type="checkbox" name="columns[]" value="nama_persidangan" x-model="columns.nama_persidangan" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                        <span class="text-sm font-medium text-gray-700">Nama Kegiatan</span>
                                                    </label>
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        <input type="checkbox" name="columns[]" value="jenis_persidangan" x-model="columns.jenis_persidangan" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    ...
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        ...
                                                        <span class="text-sm font-medium text-gray-700">Tempat Acara</span>
                                                    </label>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[15%]">Protokol
                                </th>
                                ...
                                <tr class="hover:bg-[#EFF6FF] transition {{ $isBoldRow ? 'bg-blue-50/30' : '' }}">
                                    ...
                                    <td class="px-3 py-4 whitespace-nowrap text-center text-xs">
                                        @php
                                            ...
                                            $date = $item->tanggal_persidangan ? $item->tanggal_persidangan->copy()->startOfDay() : null;
                                        ...
                                        <div class="inline-block px-2 py-1 rounded-lg {{ $fontWeight }} {{ $hasBg ? $chipClass . ' border' : $chipClass }}">
                                            {{ $item->tanggal_persidangan ? $item->tanggal_persidangan->format('d/m/y') : '-' }}
                                        </div>
                                    </td>
                                    ...
                                    {{-- Nama Kegiatan --}}
                                    <td class="px-3 py-4 text-left">
                                        <p class="{{ $boldTextClass }} line-clamp-3" title="{{ $item->nama_persidangan }}">{{ $item->nama_persidangan }}</p>
                                    </td>
                                    ...
                                    <td class="px-3 py-4 text-left">
                                        <span class="text-sm {{ $boldTextClass }}">
                                            {{ $item->jenisPersidangan?->nama_jenis ?? '-' }}
                                        </span>
                                    </td>
                                                ...
                                                <div x-data="{ open: false, top: 0, left: 0 }" class="relative">
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                                            ...
                                                            {{-- View --}}
                                                            <a href="{{ route('persidangan.show', $item->id_persidangan) }}"
                                                            ...
                                                            {{-- Edit --}}
                                                            <a href="{{ route('persidangan.edit', $item->id_persidangan) }}"
                                                            ...
                                                            {{-- Delete --}}
                                                            <button type="button"
                                                                    @click="confirmDelete('{{ route('persidangan.destroy', $item->id_persidangan) }}')"
