            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <h2 class="text-base font-bold text-gray-900">Daftar Kegiatan Kunjungan Kerja</h2>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        {{-- Export Button & Modal --}}
                        <div x-data="{ exportOpen: false, exportFormat: 'pdf', selectAll: true, columns: { tanggal: true, waktu: true, nama_kegiatan: true, jenis_kunjungan: true, anggota_dewan: true, rombongan: true, tujuan: true } }" 
                             class="relative">
                            ...
                            <div x-show="exportOpen" 
                                ...
                                <div @click.outside="exportOpen = false"
                                    ...
                                    <form action="{{ route('kunjungan-kerja') }}" method="GET" class="flex flex-col flex-1 overflow-hidden">
                                        {{-- Preserve filters --}}
                                        ...
                                        <div class="p-5 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
                                            ...
                                            <div>
                                                ...
                                                <div class="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                                    ...
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        <input type="checkbox" name="columns[]" value="jenis_kunjungan" x-model="columns.jenis_kunjungan" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                        <span class="text-sm font-medium text-gray-700">Jenis Kunjungan</span>
                                                    </label>
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        ...
                                                        <span class="text-sm font-medium text-gray-700">Anggota Dewan</span>
                                                    </label>
                                                     <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                                                        <input type="checkbox" name="columns[]" value="rombongan" x-model="columns.rombongan" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                        <span class="text-sm font-medium text-gray-700">Rombongan</span>
                                                    </label>
                                                    <label class="flex items-center gap-2 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition cursor-pointer">
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[12%]">Rombongan
                                </th>
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[18%]">Nama
                                    Kegiatan
                                </th>
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[12%]">Tujuan
                                </th>
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[16%]">Protokol
                                </th>
                                <th class="px-3 py-3 text-xs font-semibold text-gray-500 uppercase text-left w-[12%]">Jenis Kunjungan
                                </th>
                        ...
                        <tbody class="divide-y divide-gray-100" x-show="!loading" x-cloak
                                    ...
                                    <td class="px-3 py-4 text-left">
                                        <div class="flex items-center gap-1.5 {{ $boldTextClass }}">
                                            ...
                                            <span class="text-sm">
                                                ...
                                                @else
                                                    {{ $item->tujuan_luar_negeri ?? 'Luar Negeri' }}
                                                @endif
                                            </span>
                                        </div>
                                    </td>
                                                ...
                                                <div x-data="{ open: false, top: 0, left: 0 }" class="relative">
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                                            ...
                                                            {{-- View --}}
                                                            <a href="{{ route('kunjungan-kerja.show', $item->id_kunjungan) }}"
                                                            ...
                                                            {{-- Edit --}}
                                                            <a href="{{ route('kunjungan-kerja.edit', $item->id_kunjungan) }}"
                                                            ...
                                                            {{-- Delete --}}
                                                            <button type="button"
                                                                    @click="confirmDelete('{{ route('kunjungan-kerja.destroy', $item->id_kunjungan) }}', '{{ $item->nama_kegiatan }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ 8 + ($visibleColumns['file'] ? 1 : 0) + ($visibleColumns['last_update'] ? 1 : 0) }}" class="px-6 py-8 text-center text-gray-500">
