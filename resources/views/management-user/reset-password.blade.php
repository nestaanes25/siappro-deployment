                            ...
                            <div class="flex items-stretch gap-2">
                                <div class="relative flex-1 group">
                                    ...
                                    <button type="button" @click="showPw = !showPw"
                                        ...
                                        <svg x-show="!showPw" class="h-5 w-5" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input :type="showConfirm ? 'text' : 'password'" name="password_confirmation"
                                    id="password_confirmation" x-model="passwordConfirmation"
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            ...
                            <ul class="space-y-1.5">
                                ...
                                <li class="flex items-center gap-2 text-xs transition-colors duration-200"
                                    :class="hasLength ? 'text-green-600 font-medium' : 'text-gray-400'">
                                ...
                                {{-- Uppercase --}}
                                <li class="flex items-center gap-2 text-xs transition-colors duration-200"
                                    :class="hasUpper ? 'text-green-600 font-medium' : 'text-gray-400'">
                                ...
                                {{-- Number --}}
                                <li class="flex items-center gap-2 text-xs transition-colors duration-200"
                                    :class="hasNumber ? 'text-green-600 font-medium' : 'text-gray-400'">
                                ...
                                {{-- Special --}}
                                <li class="flex items-center gap-2 text-xs transition-colors duration-200"
                                    :class="hasSpecial ? 'text-green-600 font-medium' : 'text-gray-400'">
